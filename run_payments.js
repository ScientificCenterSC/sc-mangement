const document = { getElementById: () => ({ value: 'all', addEventListener: () => {}, innerHTML: '' }) }; const window = { addEventListener: () => {} }; const allStudents = [], allPayments = [], allCourses = [], allDepts = [], allFloors = [], allGroups = [], allAddOns = [];

    ...
    async function loadData() {
        ...
        try {
            ...
            trainerFilter.innerHTML = '<option value="all">Ø§Ù„ÙƒÙ„</option>';
    ...
    function populateGlobalFilters() {
        ...
        deptFilter.innerHTML = '<option value="all">Ø§Ù„ÙƒÙ„</option>' + 
            '<option value="1">ØªÙ‚Ù†ÙŠØ© Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª</option>' +
            '<option value="2">Ø§Ù„Ù„ØºØ§Øª</option>' +
            '<option value="3">Ø¥Ø¯Ø§Ø±Ø© Ø§Ù„Ø£Ø¹Ù…Ø§Ù„</option>' +
            '<option value="4">Ø§Ù„ØªØµÙ…ÙŠÙ…</option>';

        deptFilter.addEventListener('change', () => {
            const dId = deptFilter.value;
            courseFilter.innerHTML = '<option value="all">Ø§Ù„ÙƒÙ„</option>';
            groupFilter.innerHTML = '<option value="all">Ø§Ù„ÙƒÙ„</option>';
            if(dId !== 'all') {
    ...
    function refreshFinancialReport() {
        ...
        document.getElementById('financialStats').innerHTML = \
            <div class="stat-card"><div class="stat-info"><div class="stat-value">\ Ø¬.Ù…</div><div class="stat-label">Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ø¥ÙŠØ±Ø§Ø¯Ø§Øª</div></div><div class="stat-icon"><i class="fas fa-dollar-sign"></i></div></div>
            <div class="stat-card"><div class="stat-info"><div class="stat-value">\ Ø¬.Ù…</div><div class="stat-label">Ø§Ù„Ù…ØªØ¨Ù‚ÙŠ</div></div><div class="stat-icon"><i class="fas fa-clock"></i></div></div>
            <div class="stat-card"><div class="stat-info"><div class="stat-value">\</div><div class="stat-label">Ø¹Ø¯Ø¯ Ø§Ù„Ù…Ø¹Ø§Ù…Ù„Ø§Øª</div></div><div class="stat-icon"><i class="fas fa-receipt"></i></div></div>
        \;
    ...
    function updateMonthlyRevenueChart(payments) {
        ...
        monthlyRevenueChart = new Chart(ctx, {
            type: 'line',
            data: { labels: months, datasets: [{ label: 'Ø§Ù„Ø¥ÙŠØ±Ø§Ø¯Ø§Øª (Ø¬.Ù…)', data: monthlyData, borderColor: '#3c6ec8', backgroundColor: 'rgba(60,110,200,0.05)', tension: 0.3, fill: true }] },
    ...
    function refreshAttendanceReport() {
        ...
        document.getElementById('attendanceHeader').innerHTML = '<th>Ø§Ù„ÙŠÙˆÙ…</th><th>Ø§Ù„ÙˆÙ‚Øª</th><th>Ø§Ù„Ù…Ø¯Ø±Ø¨</th><th>Ø§Ù„Ù‚Ø§Ø¹Ø©</th><th>Ø§Ù„Ø¬Ø±ÙˆØ¨</th>';
    }
    ...
    function refreshOverdueReport() {
        ...
        document.getElementById('overdueStats').innerHTML = \
            <div class="stat-card"><div class="stat-info"><div class="stat-value">\</div><div class="stat-label">Ø¹Ø¯Ø¯ Ø§Ù„Ø·Ù„Ø§Ø¨ Ø§Ù„Ù…ØªØ£Ø®Ø±ÙŠÙ†</div></div><div class="stat-icon"><i class="fas fa-users"></i></div></div>
            <div class="stat-card"><div class="stat-info"><div class="stat-value">\ Ø¬.Ù…</div><div class="stat-label">Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ù…ØªØ£Ø®Ø±Ø§Øª</div></div><div class="stat-icon"><i class="fas fa-dollar-sign"></i></div></div>
        \;
        ...
        document.getElementById('overdueBody').innerHTML = overdueStudents.map(s => {
            ...
            return \
                <tr>
                    ...
                    <td>\</td>
                    <td>\</td>
                    <td style="color: #e74c3c; font-weight: 600;">\ Ø¬.Ù…</td>
                    <td>\</td>
                </tr>
            \;
        }).join('');
